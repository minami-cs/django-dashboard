...
def seoulkids(request):
    data = MyAnalysis().kidsnum()
    print(data)
    return HttpResponse(json.dumps(data), content_type='application/json')
...
def similarloc(request):
    loc = request.GET['loc']
    data = MyAnalysis().shindorim(loc)
    print(data)
    return HttpResponse(json.dumps(data), content_type='application/json')
...
def yearonyear(request):
    data = MyAnalysis().fiveyears()
    print(data)
    return HttpResponse(json.dumps(data), content_type='application/json')